    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-2">Tournament Manager 2</p>
        </div>

        <div className="rounded-xl card-gradient border border-border shadow-card p-6">
          <h2 className="text-lg font-display font-bold text-foreground mb-1">{isLogin ? "Entrar" : "Criar Conta"}</h2>
