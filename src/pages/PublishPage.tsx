...
export default function PublishPage() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .select("*")
      .eq("published_tournament_id", selectedPub)
      .then(({ data }) => {
  ...
  return (
    <div className="p-6 lg:p-10 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-display font-bold text-foreground tracking-tight">Publicar Competições</h1>
        <p className="text-sm text-muted-foreground mt-1">Compartilhe suas competições com outros usuários</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          {selectedPub ? (
            <div className="space-y-4">
              <h2 className="text-sm font-display font-bold text-foreground uppercase tracking-wider">Colaboradores</h2>
              <div className="p-4 rounded-xl bg-card text-card-foreground border border-border space-y-4">
                  ...
                  <Select value={newRole} onValueChange={setNewRole}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="admin">
                        <span className="flex items-center gap-1.5">
                          <ShieldIcon className="w-3 h-3" /> Administrador
                        </span>
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                {collaborators.length === 0 ? (
                  <p className="text-xs text-muted-foreground text-center py-4">Nenhum colaborador adicionado</p>
                ) : (
