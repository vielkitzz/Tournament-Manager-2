...
export default function SoccerBallIcon({ size = 24, className, ...props }: Props) {
  return (
    <svg height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" className={className} {...props}>
